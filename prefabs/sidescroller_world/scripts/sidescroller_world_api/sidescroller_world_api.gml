...
#macro WORLD_CAM_SAFE 420      // half-width of the band the focus may move in freely
...
function world_cam_follow_x(_cam_x, _focus_x, _view_w) {
    var _left  = _cam_x + _view_w * 0.5 - WORLD_CAM_SAFE;
    var _right = _cam_x + _view_w * 0.5 + WORLD_CAM_SAFE;
    var _want  = _cam_x;
